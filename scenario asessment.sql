...
create table order(Id int primary key,order_date date,order_number int,cust_id int,total_amount int)
...
create view myview 
as
select prod.prod_name,orderitem.quantity,order.order_number 
from prod,orderitem,order
